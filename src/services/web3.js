...
export async function getTokenTxs(wallet) {
  ...
  let variables = {
    network: "bsc",
    wallet: wallet,
    address: "0x35E583bD317D611b51FEdAaaedcaC4a4ECe6C711",
  };
  return await axios({
    method: "post",
...
export async function getAllTokenTxs() {
  let query = `{
    ethereum(network: bsc) {
      transfers(options: {desc: "block.timestamp.time", limit: 100000, offset: 0}, date: {since: "2021-05-25", till: null}, amount: {gt: 0}, currency: {is: "0x35E583bD317D611b51FEdAaaedcaC4a4ECe6C711"}) {
        block {
          timestamp {
...
transfers(options:{desc: "block.timestamp.time", limit: $limit, offset: $offset},
  ...
  let variables = {
    ...
    offset: 0,
    network: "bsc",
    address: "0xE57694B819E94A47345c9890d1ad6e9Ea6885f3e",
